...
<body>
    ...
    <div id="superMain" class='col-9'>
        <div id="mainPage">     
            <a href="userBaptismCertificateRequest.php" id="baptismLink" class="bg" onclick="return requireLogin(this)">Baptism</a>
            <a href="userWeddingCertificateRequest.php" id="weddingLink" class="bg" onclick="return requireLogin(this)">Wedding</a>
        </div>
    </div>
</body>
</html>
