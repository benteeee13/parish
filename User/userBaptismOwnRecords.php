...
// Fetch records that belong to the logged-in user, ensuring non-deleted entries are shown
$query = "SELECT id, child_name, mother_name, father_name, status, date_baptized 
...
$total_query = "SELECT COUNT(*) AS total FROM baptism_applications WHERE is_deleted = 0";
    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div class='col-9 mx-auto'>
                <h2 id="forLabel" class='mx-5 mt-5 white'>Baptism</h2>
                <div id="mainPage">
