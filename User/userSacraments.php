...
<head>
    ...
    <script>
       function baptism() { window.location.href = 'userBaptism.php'; }
       function wedding() { window.location.href = 'userWedding.php'; }
    </script>
    <style>
        body {
        ...
        .img-fluid {
    width: 800px;
    height: 600px; /* Fixed dimensions */
    object-fit: cover; /* Ensures the image maintains aspect ratio and fits the area */
    border-radius: 8px;
    margin-top: 10px;
}
 p.copyright {
...
<body>
    ...
    <div id="aboutDiv">
        <h1 style ="margin-top : 100px;" class="text-center">SEVEN CATHOLIC SACRAMENTS</h1>

        <div id="sacramentCarousel" class="carousel slide" data-ride="carousel">
            <!-- Indicators -->
            <ul class="carousel-indicators">
                <li data-target="#sacramentCarousel" data-slide-to="0" class="active"></li>
                <li data-target="#sacramentCarousel" data-slide-to="1"></li>
                <li data-target="#sacramentCarousel" data-slide-to="2"></li>
                <li data-target="#sacramentCarousel" data-slide-to="3"></li>
                <li data-target="#sacramentCarousel" data-slide-to="4"></li>
                <li data-target="#sacramentCarousel" data-slide-to="5"></li>
                <li data-target="#sacramentCarousel" data-slide-to="6"></li>
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="text-center">
                        <img src="../Images/baptismLogo.jpg" class="img-fluid" alt="Baptism Logo" style="width: 800px; height: 600">
                        <h2>BAPTISM</h2>
                ...
                <div class="carousel-item">
                    <div class="text-center">
                        <img src="../Images/father.jpg" class="img-fluid" alt="Eucharist Logo" style="width: 800px; height: 600">
                        <h2>EUCHARIST</h2>
                ...
                <div class="carousel-item">
                    <div class="text-center">
                        <img src="../Images/confirmationLogo.jpg" class="img-fluid" alt="Confirmation Logo" style="width: 800px; height: 600">
                    <h2>CONFIRMATION</h2>
                ...
                <div class="carousel-item">
                    <div class="text-center">
                    <img src="../Images/reconciliationLogo.jpg" class="img-fluid" alt="Reconciliation Logo" style="width: 800px; height: 600;">
                ...
                <div class="carousel-item">
                    <div class="text-center">
                    <img src="../Images/annointingLogo.jpg" class="img-fluid" alt="Annoint Logo" style="width: 800px; height: 600">
                ...
                <div class="carousel-item">
                    <div class="text-center">
                    <img src="../Images/marriageLogo.jpg" class="img-fluid" alt="Marriage Logo" style="width: 800px; height: 600">
                    <h2>MARRIAGE</h2>
                    ...
                    <p class="info2nd">with any children to be raised within the teachings of the church.</p><br>
                ...
                <div class="carousel-item">
                    <div class="text-center">
                   <img src="../Images/ordersLogo.jpg" class="img-fluid" alt="Order Logo" style="width: 800px; height: auto;">                   
                    <h2>HOLY ORDERS</h2>
            ...
            <!-- Carousel controls -->
            <a class="carousel-control-prev" href="#sacramentCarousel" data-slide="prev">
                <span class="carousel-control-prev-icon"></span>
            </a>
            <a class="carousel-control-next" href="#sacramentCarousel" data-slide="next">
