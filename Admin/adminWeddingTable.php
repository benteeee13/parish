...
<body>
    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div class='col-9'>
                 <h2 class='mx-5 mt-5 white'>Wedding</h2>
                <div id="mainPage">
                   <div class="table-container bg-light p-5 ">
                    <div class="d-flex justify-content-between">
                      <div class='d-flex'>
                        <a href='#' class='mx-3 text-danger' onclick="window.location.href='adminWeddingApprovedSchedule.php'">CHECK THE APPROVED SCHEDULE</a>
                      </div>
                                    ...
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td class="action-buttons">
                                                <button onclick="window.location.href='adminViewWeddingApplication.php?id=<?php echo $row['id']; ?>'" id="viewButtons">View</button>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
