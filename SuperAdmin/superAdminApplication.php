    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div class='col-9'>
                ...
                <div id="mainPage">     
                    <a href="superAdminBaptismSchedule.php" id="serviceLink" class="bg">Baptism</a>
                    <a href="superAdminWeddingSchedule.php" id="scheduleLink" class="bg">Wedding</a>
                    <a href="superAdminMass.php" id="recordsLink" class="bg">Mass</a>
                </div>
            </div>
        </div>
    </div>
