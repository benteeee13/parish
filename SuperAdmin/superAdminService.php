    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div class='col-9'>
                ...
                <div id="mainPage">     
                    <a href="superAdminApplication.php" id="serviceLink" class="bg">Application</a>
                    <a href="superAdminRequest.php" id="scheduleLink" class="bg">Record Request</a>
                    <!--<a href="superAdminMessage.php" id="recordsLink" class="bg">Message</a>-->
                </div>
            </div>
        </div>
    </div>
