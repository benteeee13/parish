                ...
                <div id="mainPage">
                    <div class="table-container bg-light p-5 ">
                        <div class="d-flex justify-content-between">
                            <div class='d-flex'>
                                <a href='superAdminWeddingAddRecords.php' class='mx-3 text-danger'>Add Records</a>
                            </div>
                                ...
                                <?php if ($result->num_rows > 0): ?>
                                    <?php while ($row = $result->fetch_assoc()): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="printWeddingCertificate.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-sm">Print Certificate</a>
                                            </td>
                                        </tr>
                                    <?php endwhile; ?>
                                <?php else: ?>
