    ...
    <body>
        ...
        <div class='row'>
            ...
            <div class='col-9'>
                ...
                <div id="mainPage">     
                    <a href="superAdminFuneralDeclinedRequest.php" id="serviceLink" class="bg">Funeral</a>
                    <a href="superAdminPrivateMassDeclinedRequest.php" id="scheduleLink" class="bg">Private Mass</a> 
                </div>
            </div>
        </div>
        </div>
