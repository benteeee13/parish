...
$query = "SELECT * FROM baptism_applications WHERE id = ?";
...
<body onload="printAndRedirect();">
    <div class="certificate">
        ...
        <table class="info-table">
            <tr>
                <td><strong>Name of Child:</strong></td>
                <td><?php echo strtoupper($data['child_name']); ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><?php echo $data['date_baptized']; ?></td>
            </tr>
            <tr>
    ...
    <script>
        function printAndRedirect() {
            window.print();
            setTimeout(function() {
                window.location.href = 'superAdminBaptismRecords.php';
