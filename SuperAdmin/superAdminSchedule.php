...
if (!isset($_SESSION['superAdminUsername'])) {
    header("Location: superAdminUserLogin.php");
    exit();
}
...
<body>
    ...
    <div id="mainDiv">
        ...
        <div class="text-space-between">
            <a href="superAdminSchedule.php?month=<?php echo ($month == 1 ? 12 : $month - 1); ?>&year=<?php echo ($month == 1 ? $year - 1 : $year); ?>" class="btn btn-secondary">Previous</a>
            <a href="superAdminHomepage.php" class="btn btn-danger">Back</a>
            <a href="superAdminSchedule.php?month=<?php echo ($month == 12 ? 1 : $month + 1); ?>&year=<?php echo ($month == 12 ? $year + 1 : $year); ?>" class="btn btn-secondary">Next</a>
        </div>
    </div>
</body>
</html>
