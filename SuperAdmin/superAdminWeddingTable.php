...
$total_query = "SELECT COUNT(*) AS total FROM wedding_applications WHERE is_forwarded = '1'";
...
<head>
    ...
    <script>
        ...
        function updateStatus(id, status) {
            fetch('superAdminUpdateWeddingApplicationStatus.php', {
                method: 'POST',
                headers: {
...
<body>
    ...
    <div class='container-fluid'>
        <div class='row'>
            ...
            <div class='col-9'>
                 <h2 class='mx-5 mt-5 white'>Schedule Approve</h2>
                 <div id="mainPage">
                   <div class="table-container bg-light p-5 ">
                    <div class="d-flex justify-content-between">
                      <div class='d-flex'>
                        <a href='superAdminWeddingApprovedRequest.php' class='mx-3 text-danger '>CHECK THE APPROVED SCHEDULE </a>
                      </div>
