...
function updateStatus(id, status) {
    fetch('superAdminUpdatePrivateMassApplicationStatus.php', {
        method: 'POST',
        headers: {
                 ...
                 <div id="mainPage">
                   <div class="table-container bg-light p-5 ">
                    <div class="d-flex justify-content-between">
                      <div class='d-flex'>
                        <a href='superAdminPrivateMassApprovedRequest.php' class='mx-3 text-danger '>CHECK THE APPROVED SCHEDULE </a>
                      </div>
