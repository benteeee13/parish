    ...
    <body>
        ...
        <div class='row'>
            ...
            <div class='col-9'>
                ...
                <div id="mainPage">     
                    <a href="superAdminPrivateMassTable.php" id="serviceLink" class="bg">Application Requests</a>
                    <a href="superAdminPrivateMassApprovedRequest.php" id="scheduleLink" class="bg">Approved Schedule</a>
                </div>
            </div>
        </div>
        </div>
