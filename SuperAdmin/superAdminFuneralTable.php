...
$total_query = "SELECT COUNT(*) AS total FROM funeral_applications WHERE is_forwarded = '1'";
...
function updateStatus(id, status) {
    fetch('superAdminUpdateFuneralApplicationStatus.php', {
        method: 'POST',
        headers: {
                 ...
                 <div id="mainPage">
                   <div class="table-container bg-light p-5 ">
                    <div class="d-flex justify-content-between">
                      <div class='d-flex'>
                        <a href='superAdminFuneralApprovedRequest.php' class='mx-3 text-danger '>CHECK THE APPROVED SCHEDULE </a>
                      </div>
